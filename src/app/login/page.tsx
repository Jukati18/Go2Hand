...
// Login page
//
// Layout (desktop): teal brand panel (left) | form (right)
// Layout (mobile):  logo + form, full-width
//
// Features:
//   • Email + password with real-time validation on blur
//   • Show / hide password toggle
//   • Google OAuth (browser Supabase client)
//   • Redirect to ?next= URL after success
//   • Friendly server-side error display
...
// ── Trust points shown in the brand panel ─────────────────────────
const TRUST = [
...
function LoginForm() {
    ...
    // Derived errors (only show after field is touched)
    ...
    const handleSubmit = useCallback(
        async (e: FormEvent) => {
            ...
            // Success — push to next URL and refresh so server
            // components pick up the new session.
            router.push(nextUrl)
            router.refresh()
        },
    ...
    const handleGoogle = useCallback(async () => {
        ...
        // On success, Google redirects the browser — no further JS needed
    }, [nextUrl])
        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex flex-col justify-between w-[480px] shrink-0
                ...
                <div className="flex-1 flex flex-col justify-center gap-8 my-10">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/10">
                        <p className="text-teal-50 text-sm leading-relaxed italic mb-3">
                            ...
                            gave me total peace of mind — my money was safe the whole time.&rdquo;
                        </p>
                ...
                <p className="text-teal-500 text-xs">
                    © 2025 Go2Hand · IMEI verified · Escrow protected
                </p>
            </div>
