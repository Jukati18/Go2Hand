...
// ─────────────────────────────────────────────────────────────────────────────
// DevicesContent — the real component that uses useSearchParams()
// Must be rendered inside <Suspense> so Next.js can prerender the outer shell
// ─────────────────────────────────────────────────────────────────────────────
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center justify-end gap-3 mb-5">
                        ...
                        <select
                            value={sortBy}
                            onChange={e => {
                                setSortBy(e.target.value as ListingFilters['sortBy'])
                                setPage(1)
                            }}
...
// ─────────────────────────────────────────────────────────────────────────────
// Skeleton shown while DevicesContent is loading its client-side JS bundle
// ─────────────────────────────────────────────────────────────────────────────
        ...
        <div className="max-w-[1160px] mx-auto px-6 py-10">
            ...
            <div className="flex gap-8">
                <aside className="w-56 shrink-0">
                    <div className="bg-gray-100 h-40 rounded-xl animate-pulse" />
                </aside>
...
// ─────────────────────────────────────────────────────────────────────────────
// DevicesPage — exported default, wraps content in Suspense
// This outer shell is what Next.js prerenders; DevicesContent runs on the client
// ─────────────────────────────────────────────────────────────────────────────
export default function DevicesPage() {
    return (
        <div className="min-h-screen bg-gray-50">
            <Navbar />
            {/*
              <Suspense> tells Next.js: "the stuff inside reads searchParams
              at runtime — prerender only the fallback skeleton, then hydrate."
            */}
