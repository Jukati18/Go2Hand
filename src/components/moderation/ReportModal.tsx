...
//
// Usage on device detail page:
//   <ReportModal targetType="listing" targetId={device.id} targetTitle={device.fullName} />
//
// Usage on profile page:
//   <ReportModal targetType="user" targetId={userId} targetTitle={username} />
//
// The modal triggers via a trigger element passed as `children`.
// ─────────────────────────────────────────────────────────────────
...
// Reasons shown differ slightly based on target type
                    ...
                    <div className="bg-white w-full max-w-[420px] rounded-2xl shadow-2xl overflow-hidden
                        ...
                        {submitted ? (
                            ...
                            <div className="px-6 py-10 flex flex-col items-center text-center gap-4">
                                <div className="w-14 h-14 bg-emerald-50 rounded-2xl flex items-center
                                    justify-center border border-emerald-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 leading-relaxed">
                                        Thanks for helping keep Go2Hand safe.
                            ...
                            <div className="p-5 flex flex-col gap-4">
                                ...
                                {error && (
                                    <div className="flex items-center gap-2.5 bg-red-50 border border-red-200
                                        rounded-xl px-4 py-3 text-xs text-red-700">
                                ...
                                <p className="text-[11px] text-gray-400 leading-relaxed">
                                    Reports are reviewed by Go2Hand staff and handled confidentially.
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        onClick={handleClose}
                                        disabled={submitting}
                                        className="flex-1 h-10 border-2 border-gray-200 text-gray-500
